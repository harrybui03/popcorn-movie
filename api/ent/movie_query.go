...
func (mq *MovieQuery) QueryShowTimes() *ShowTimeQuery {
	query := (&ShowTimeClient{config: mq.config}).Query()
...
func (mq *MovieQuery) QueryComments() *CommentQuery {
	query := (&CommentClient{config: mq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := mq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (mq *MovieQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (mq *MovieQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (mq *MovieQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (mq *MovieQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (mq *MovieQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (mq *MovieQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := mq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (mq *MovieQuery) Clone() *MovieQuery {
	...
	return &MovieQuery{
		...
		withShowTimes: mq.withShowTimes.Clone(),
...
func (mq *MovieQuery) WithShowTimes(opts ...func(*ShowTimeQuery)) *MovieQuery {
	query := (&ShowTimeClient{config: mq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	mq.withShowTimes = query
	return mq
}
...
func (mq *MovieQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Movie, error) {
	...
	if query := mq.withShowTimes; query != nil {
		if err := mq.loadShowTimes(ctx, query, nodes,
			func(n *Movie) { n.Edges.ShowTimes = []*ShowTime{} },
			func(n *Movie, e *ShowTime) { n.Edges.ShowTimes = append(n.Edges.ShowTimes, e) }); err != nil {
			return nil, err
		}
	}
...
func (mq *MovieQuery) loadShowTimes(ctx context.Context, query *ShowTimeQuery, nodes []*Movie, init func(*Movie), assign func(*Movie, *ShowTime)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*Movie)
	for i := range nodes {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(showtime.FieldMovieID)
	}
	query.Where(predicate.ShowTime(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(movie.ShowTimesColumn), fks...))
	}))
...
func (mq *MovieQuery) loadComments(ctx context.Context, query *CommentQuery, nodes []*Movie, init func(*Movie), assign func(*Movie, *Comment)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(comment.FieldMovieID)
	}
	query.Where(predicate.Comment(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(movie.CommentsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (mq *MovieQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(movie.Table, movie.Columns, sqlgraph.NewFieldSpec(movie.FieldID, field.TypeUUID))
	_spec.From = mq.sql
...
func (mq *MovieQuery) ForUpdate(opts ...sql.LockOption) *MovieQuery {
...
func (mq *MovieQuery) ForShare(opts ...sql.LockOption) *MovieQuery {
	if mq.driver.Dialect() == dialect.Postgres {
		mq.Unique(false)
	}
	mq.modifiers = append(mq.modifiers, func(s *sql.Selector) {
