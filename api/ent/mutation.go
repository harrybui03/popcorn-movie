...
const (
	...
	TypeMovie         = "Movie"
	TypeResetPassword = "ResetPassword"
	TypeRoom          = "Room"
	TypeSeat          = "Seat"
	TypeSession       = "Session"
...
// ResetPasswordMutation represents an operation that mutates the ResetPassword nodes in the graph.
type ResetPasswordMutation struct {
	...
	oldValue      func(context.Context) (*ResetPassword, error)
	predicates    []predicate.ResetPassword
}

var _ ent.Mutation = (*ResetPasswordMutation)(nil)

// resetpasswordOption allows management of the mutation configuration using functional options.
type resetpasswordOption func(*ResetPasswordMutation)

// newResetPasswordMutation creates new mutation for the ResetPassword entity.
func newResetPasswordMutation(c config, op Op, opts ...resetpasswordOption) *ResetPasswordMutation {
	m := &ResetPasswordMutation{
		config:        c,
		op:            op,
		typ:           TypeResetPassword,
		clearedFields: make(map[string]struct{}),
	}
	for _, opt := range opts {
		opt(m)
...
// withResetPasswordID sets the ID field of the mutation.
func withResetPasswordID(id uuid.UUID) resetpasswordOption {
	return func(m *ResetPasswordMutation) {
		var (
			err   error
			once  sync.Once
			value *ResetPassword
		)
		m.oldValue = func(ctx context.Context) (*ResetPassword, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().ResetPassword.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withResetPassword sets the old ResetPassword of the mutation.
func withResetPassword(node *ResetPassword) resetpasswordOption {
	return func(m *ResetPasswordMutation) {
		m.oldValue = func(context.Context) (*ResetPassword, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
// Client returns a new `ent.Client` from the mutation. If the mutation was
// executed in a transaction (ent.Tx), a transactional client is returned.
func (m ResetPasswordMutation) Client() *Client {
	client := &Client{config: m.config}
	client.init()
	return client
}
...
// Tx returns an `ent.Tx` for mutations that were executed in transactions;
// it returns an error otherwise.
func (m ResetPasswordMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, errors.New("ent: mutation is not running in a transaction")
	}
	tx := &Tx{config: m.config}
...
// SetID sets the value of the id field. Note that this
// operation is only accepted on creation of ResetPassword entities.
func (m *ResetPasswordMutation) SetID(id uuid.UUID) {
	m.id = &id
}

// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *ResetPasswordMutation) ID() (id uuid.UUID, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *ResetPasswordMutation) IDs(ctx context.Context) ([]uuid.UUID, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().ResetPassword.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
// SetUserID sets the "user_id" field.
func (m *ResetPasswordMutation) SetUserID(u uuid.UUID) {
	m.user = &u
}

// UserID returns the value of the "user_id" field in the mutation.
func (m *ResetPasswordMutation) UserID() (r uuid.UUID, exists bool) {
	v := m.user
	if v == nil {
		return
	}
...
// OldUserID returns the old "user_id" field's value of the ResetPassword entity.
// If the ResetPassword object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ResetPasswordMutation) OldUserID(ctx context.Context) (v uuid.UUID, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldUserID is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetUserID resets all changes to the "user_id" field.
func (m *ResetPasswordMutation) ResetUserID() {
	m.user = nil
}

// SetCreatedAt sets the "created_at" field.
func (m *ResetPasswordMutation) SetCreatedAt(t time.Time) {
	m.created_at = &t
}

// CreatedAt returns the value of the "created_at" field in the mutation.
func (m *ResetPasswordMutation) CreatedAt() (r time.Time, exists bool) {
	v := m.created_at
	if v == nil {
		return
	}
...
// OldCreatedAt returns the old "created_at" field's value of the ResetPassword entity.
// If the ResetPassword object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ResetPasswordMutation) OldCreatedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldCreatedAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetCreatedAt resets all changes to the "created_at" field.
func (m *ResetPasswordMutation) ResetCreatedAt() {
	m.created_at = nil
}

// ClearUser clears the "user" edge to the User entity.
func (m *ResetPasswordMutation) ClearUser() {
	m.cleareduser = true
	m.clearedFields[resetpassword.FieldUserID] = struct{}{}
}

// UserCleared reports if the "user" edge to the User entity was cleared.
func (m *ResetPasswordMutation) UserCleared() bool {
	return m.cleareduser
}
...
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// UserID instead. It exists only for internal usage by the builders.
func (m *ResetPasswordMutation) UserIDs() (ids []uuid.UUID) {
	if id := m.user; id != nil {
		ids = append(ids, *id)
	}
	return
...
// ResetUser resets all changes to the "user" edge.
func (m *ResetPasswordMutation) ResetUser() {
	m.user = nil
	m.cleareduser = false
}

// Where appends a list predicates to the ResetPasswordMutation builder.
func (m *ResetPasswordMutation) Where(ps ...predicate.ResetPassword) {
	m.predicates = append(m.predicates, ps...)
}

// WhereP appends storage-level predicates to the ResetPasswordMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *ResetPasswordMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.ResetPassword, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// Op returns the operation name.
func (m *ResetPasswordMutation) Op() Op {
	return m.op
}

// SetOp allows setting the mutation operation.
func (m *ResetPasswordMutation) SetOp(op Op) {
	m.op = op
}

// Type returns the node type of this mutation (ResetPassword).
func (m *ResetPasswordMutation) Type() string {
	return m.typ
}
...
// order to get all numeric fields that were incremented/decremented, call
// AddedFields().
func (m *ResetPasswordMutation) Fields() []string {
	fields := make([]string, 0, 2)
	if m.user != nil {
		fields = append(fields, resetpassword.FieldUserID)
	}
	if m.created_at != nil {
		fields = append(fields, resetpassword.FieldCreatedAt)
	}
	return fields
}
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *ResetPasswordMutation) Field(name string) (ent.Value, bool) {
	switch name {
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *ResetPasswordMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case resetpassword.FieldUserID:
		return m.OldUserID(ctx)
	case resetpassword.FieldCreatedAt:
	...
	return nil, fmt.Errorf("unknown ResetPassword field %s", name)
}

// SetField sets the value of a field with the given name. It returns an error if
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *ResetPasswordMutation) SetField(name string, value ent.Value) error {
	switch name {
	case resetpassword.FieldUserID:
		v, ok := value.(uuid.UUID)
		if !ok {
	...
	return fmt.Errorf("unknown ResetPassword field %s", name)
}

// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *ResetPasswordMutation) AddedFields() []string {
	return nil
}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *ResetPasswordMutation) AddedField(name string) (ent.Value, bool) {
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *ResetPasswordMutation) AddField(name string, value ent.Value) error {
	switch name {
	}
	return fmt.Errorf("unknown ResetPassword numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *ResetPasswordMutation) ClearedFields() []string {
	return nil
}

// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *ResetPasswordMutation) FieldCleared(name string) bool {
	_, ok := m.clearedFields[name]
	return ok
}
...
// ClearField clears the value of the field with the given name. It returns an
// error if the field is not defined in the schema.
func (m *ResetPasswordMutation) ClearField(name string) error {
	return fmt.Errorf("unknown ResetPassword nullable field %s", name)
}

// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *ResetPasswordMutation) ResetField(name string) error {
	switch name {
	case resetpassword.FieldUserID:
		m.ResetUserID()
		return nil
...
// AddedEdges returns all edge names that were set/added in this mutation.
func (m *ResetPasswordMutation) AddedEdges() []string {
	edges := make([]string, 0, 1)
	if m.user != nil {
		edges = append(edges, resetpassword.EdgeUser)
	}
	return edges
}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *ResetPasswordMutation) AddedIDs(name string) []ent.Value {
	switch name {
	case resetpassword.EdgeUser:
		if id := m.user; id != nil {
			return []ent.Value{*id}
		}
	}
...
// RemovedEdges returns all edge names that were removed in this mutation.
func (m *ResetPasswordMutation) RemovedEdges() []string {
	edges := make([]string, 0, 1)
	return edges
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *ResetPasswordMutation) RemovedIDs(name string) []ent.Value {
	return nil
}

// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *ResetPasswordMutation) ClearedEdges() []string {
	edges := make([]string, 0, 1)
	if m.cleareduser {
		edges = append(edges, resetpassword.EdgeUser)
	}
...
// EdgeCleared returns a boolean which indicates if the edge with the given name
// was cleared in this mutation.
func (m *ResetPasswordMutation) EdgeCleared(name string) bool {
	switch name {
	case resetpassword.EdgeUser:
		return m.cleareduser
	}
...
// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *ResetPasswordMutation) ClearEdge(name string) error {
	switch name {
	case resetpassword.EdgeUser:
		m.ClearUser()
		return nil
	}
	return fmt.Errorf("unknown ResetPassword unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *ResetPasswordMutation) ResetEdge(name string) error {
	switch name {
	case resetpassword.EdgeUser:
		m.ResetUser()
		return nil
	}
	return fmt.Errorf("unknown ResetPassword edge %s", name)
}
...
type UserMutation struct {
	...
	removedcomments       map[uuid.UUID]struct{}
	clearedcomments       bool
	reset_password        map[uuid.UUID]struct{}
	removedreset_password map[uuid.UUID]struct{}
	clearedreset_password bool
	done                  bool
...
func (m *UserMutation) AddResetPasswordIDs(ids ...uuid.UUID) {
	if m.reset_password == nil {
		m.reset_password = make(map[uuid.UUID]struct{})
	}
	for i := range ids {
		m.reset_password[ids[i]] = struct{}{}
	}
}

// ClearResetPassword clears the "reset_password" edge to the ResetPassword entity.
func (m *UserMutation) ClearResetPassword() {
	m.clearedreset_password = true
}

// ResetPasswordCleared reports if the "reset_password" edge to the ResetPassword entity was cleared.
func (m *UserMutation) ResetPasswordCleared() bool {
	return m.clearedreset_password
}

// RemoveResetPasswordIDs removes the "reset_password" edge to the ResetPassword entity by IDs.
func (m *UserMutation) RemoveResetPasswordIDs(ids ...uuid.UUID) {
	if m.removedreset_password == nil {
		m.removedreset_password = make(map[uuid.UUID]struct{})
	}
	for i := range ids {
		delete(m.reset_password, ids[i])
		m.removedreset_password[ids[i]] = struct{}{}
	}
}

// RemovedResetPassword returns the removed IDs of the "reset_password" edge to the ResetPassword entity.
func (m *UserMutation) RemovedResetPasswordIDs() (ids []uuid.UUID) {
	for id := range m.removedreset_password {
		ids = append(ids, id)
	}
	return
}

// ResetPasswordIDs returns the "reset_password" edge IDs in the mutation.
func (m *UserMutation) ResetPasswordIDs() (ids []uuid.UUID) {
	for id := range m.reset_password {
		ids = append(ids, id)
	}
	return
}

// ResetResetPassword resets all changes to the "reset_password" edge.
func (m *UserMutation) ResetResetPassword() {
	m.reset_password = nil
	m.clearedreset_password = false
	m.removedreset_password = nil
}
...
func (m *UserMutation) AddedEdges() []string {
	...
	if m.reset_password != nil {
		edges = append(edges, user.EdgeResetPassword)
	}
	return edges
}
...
func (m *UserMutation) AddedIDs(name string) []ent.Value {
	...
	case user.EdgeComments:
		...
		return ids
	case user.EdgeResetPassword:
		ids := make([]ent.Value, 0, len(m.reset_password))
		for id := range m.reset_password {
			ids = append(ids, id)
		}
		return ids
...
func (m *UserMutation) RemovedIDs(name string) []ent.Value {
	...
	case user.EdgeComments:
		...
		return ids
	case user.EdgeResetPassword:
		ids := make([]ent.Value, 0, len(m.removedreset_password))
		for id := range m.removedreset_password {
			ids = append(ids, id)
		}
		return ids
